    ...
    <div className='contact--wrapper' id="contact">
      ...
      <div className="contact--form-socials-grid">
        ...
        <h3>Drop us a line</h3>
          ...
          <FormInput label='Message' type='textarea' placeholder='Enter your message here' id='email' />
          <button>Send</button>
        </form>
        <div className="contract--socials">
          <h3>Or check out these resources</h3>
          <div className="contract--socials__item-wrapper">
          ...
          <div className="contract--socials__item-wrapper">
            ...
            <div>
              ...
              <p>Our community already has over 6000 members, become one of them and discuss with others!</p>
            </div>
          </div>
        </div>
      </div>
